...
def test_ai_credit_context_shows_zero_for_organization_without_wallet():
    ...
    assert context["ai_credit_is_low"] is True


def test_ai_credit_context_uses_spendable_balance_after_reservations():
...
def test_ai_credit_context_alerts_at_exactly_500_available_credits():
...
def test_ai_credit_context_does_not_alert_above_threshold():
